...
test("getMapAfterMove", () => {
    ...
    expect(getMapAfterMove("rrrr ____ bbb_ ggb_", { from: 3, to: 2 })).toEqual(
        "rrrr ____ bbbb gg__"
    );
});
...
test("areMapsEqual", () => {
    ...
    expect(
        areMapsEqual("oo__ rrb__ bbbr ffr_ f___ oof_", "oof_ bbbr f___ oo__ ffr_ rrb__")
    ).toBeTruthy();
