...
// function calcHeuristic(map: string) {
//   const tubes = parseMap(map);
...
// function dfs(node: INode, maxDepth = MAX_DEPTH) {
...
// function bfs(node: { map: string; path: string[]; depth: number; h: number; success?: boolean }, maxDepth = MAX_DEPTH) {
//   const visited = new Set();
//   const queue = [node];
...
// function getBestNextMove(map: string) {
